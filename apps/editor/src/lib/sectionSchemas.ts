import { SectionSchema, type SectionType } from '@pawelekbyra/schema';
import type { z } from 'zod';
import { preferencesObjectSchema } from './fieldsFromSchema';

// Built once from the discriminated union already exported by @pawelekbyra/schema — no separate
