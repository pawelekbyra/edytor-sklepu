...
import { FilePageRepository } from '@pawelekbyra/persistence';
import { renderPage } from '@pawelekbyra/renderer';
  ...
  return (
    <main>
      <div style={{ background: '#111', color: '#eee', padding: '6px 12px', fontSize: 12 }}>
        ...
        <code> @pawelekbyra/renderer</code> w trybie <code>live</code>
      </div>
